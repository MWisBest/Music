...
public class VerticalTextSpinner extends View {
	...
	public VerticalTextSpinner( Context context, AttributeSet attrs,
		...
		TEXT1_Y = TEXT_SPACING;
		TEXT2_Y = TEXT_SIZE;
		TEXT3_Y = (TEXT_SIZE * 2) + (TEXT_SPACING);
		TEXT4_Y = (TEXT_SIZE * 3) + (TEXT_SPACING * 2);
		TEXT5_Y = (TEXT_SIZE * 4) + (TEXT_SPACING * 3);

		mBackgroundFocused = context.getResources().getDrawable( R.drawable.pickerbox_background, null );
		mSelectorFocused = context.getResources().getDrawable( R.drawable.pickerbox_selected, null );
		mSelectorNormal = context.getResources().getDrawable( R.drawable.pickerbox_unselected, null );
	...
	protected void onFocusChanged( boolean gainFocus, int direction,
		...
		if( gainFocus ) {
			setBackground( mBackgroundFocused );
