...
public class MediaPlaybackService extends Service {
	...
	public static final String PLAYSTATE_CHANGED = "me.mwisbest.music.playstatechanged";
	public static final String META_CHANGED = "me.mwisbest.music.metachanged";
	public static final String QUEUE_CHANGED = "me.mwisbest.music.queuechanged";

	public static final String SERVICECMD = "me.mwisbest.music.musicservicecommand";
	...
	public static final String TOGGLEPAUSE_ACTION = "me.mwisbest.music.musicservicecommand.togglepause";
	public static final String PAUSE_ACTION = "me.mwisbest.music.musicservicecommand.pause";
	public static final String PREVIOUS_ACTION = "me.mwisbest.music.musicservicecommand.previous";
	public static final String NEXT_ACTION = "me.mwisbest.music.musicservicecommand.next";
	...
	public void onCreate() {
		...
		mPreferences = getSharedPreferences( "Music", MODE_MULTI_PROCESS );
	...
	private void saveQueue( boolean full ) {
		...
		if( mPlayer.isInitialized() ) {
			ed.putInt( "seekpos", mPlayer.position() );
		}
	 ...
	 * "me.mwisbest.music.metachanged"
	 * "me.mwisbest.music.queuechanged",
	 * "me.mwisbest.music.playbackcomplete"
	 * "me.mwisbest.music.playstatechanged"
	...
	private void updateNotification() {
		...
		if( getAudioId() < 0 ) {
			// streaming
			builder = builder.setContentTitle( getPath() );
			//.setContentText( null );
		} else {
			...
			builder = builder.setContentTitle( track )
					.setContentText( album )
					.setSubText( artist );
		}
		Bitmap art = MusicUtils.getArtwork( this, getAudioId(), getAlbumId() );

		builder = builder.setLargeIcon( art )
				.setColor( MusicUtils.getAverageRGB( art ) );
		...
		builder = builder.addAction( R.drawable.ic_appwidget_music_prev, null, pi );
		...
		intent.setComponent( serviceName );
		pi = PendingIntent.getService( this, 0 /* no requestCode */, intent, 0 /* no flags */ );
		builder = builder.addAction( R.drawable.ic_appwidget_music_next, null, pi );

		builder = builder.setStyle( new Notification.MediaStyle( builder ).setShowActionsInCompactView( 0, 2 ) );
	...
	private int getNextPosition( boolean force ) {
		if( mRepeatMode == REPEAT_CURRENT ) {
			...
			// tracks.
			if( numUnplayed <= 0 ) {
				//Log.w( LOGTAG, "Everything played! Clear history." );
				// If history is not cleared here, we will start repeating after 1 go through the list!
				mHistory.clear();
	...
	private int getBookmark() {
		synchronized( this ) {
			...
			return (int)(mCursor.getLong( BOOKMARKCOLIDX ));
		}
	}
	...
	private class MultiPlayer {
		private MusicPlayer mCurrentMediaPlayer = new MusicPlayer();
		private MusicPlayer mNextMediaPlayer;
		...
		public void setNextDataSource( String path ) {
			...
			mNextMediaPlayer = new MusicPlayer();
			...
			public boolean onError( MediaPlayer mp, int what, int extra ) {
				switch( what ) {
					case MediaPlayer.MEDIA_ERROR_SERVER_DIED:
						...
						mCurrentMediaPlayer = new MusicPlayer();
						mCurrentMediaPlayer.setWakeMode( MediaPlaybackService.this, PowerManager.PARTIAL_WAKE_LOCK );
